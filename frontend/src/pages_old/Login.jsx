...
export default function Login() {
  ...
  const handleSubmit = async (e) => {
    ...
    // ✅ Guardado correcto para que lo use el interceptor
    ...
    // ✅ Recuperar última ruta guardada o ir al panel por defecto
    const destino = localStorage.getItem("ruta_destino") || "/panel";
    localStorage.removeItem("ruta_destino"); // limpiar para la próxima
    navigate(destino);
    //navigate("/panel");
    } catch (err) {
